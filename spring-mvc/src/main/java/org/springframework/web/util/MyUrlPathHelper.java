 ...
 * @since 2019-05-27
 **/
public class MyUrlPathHelper {

    private static final Log logger = LogFactory.getLog(MyUrlPathHelper.class);
    ...
    private String defaultEncoding = MyWebUtils.DEFAULT_CHARACTER_ENCODING;

    protected String getDefaultEncoding() {
        return this.defaultEncoding;
    }
    public String getContextPath(HttpServletRequest request) {
        String contextPath = (String) request.getAttribute(MyWebUtils.INCLUDE_CONTEXT_PATH_ATTRIBUTE);
        if (contextPath == null) {
    ...
    private String decodeInternal(HttpServletRequest request, String source) {
        ...
        try {
            return MyUriUtils.decode(source, enc);
        }
    ...
    public String getRequestUri(HttpServletRequest request) {
        String uri = (String) request.getAttribute(MyWebUtils.INCLUDE_REQUEST_URI_ATTRIBUTE);
        if (uri == null) {
    ...
    public String getServletPath(HttpServletRequest request) {
        String servletPath = (String) request.getAttribute(MyWebUtils.INCLUDE_SERVLET_PATH_ATTRIBUTE);
        if (servletPath == null) {
    ...
    private boolean shouldRemoveTrailingServletPathSlash(HttpServletRequest request) {
        ...
        if (flagToUse == null) {
            ClassLoader classLoader = MyUrlPathHelper.class.getClassLoader();
